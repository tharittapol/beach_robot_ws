...
static float SPIN_U_FLOOR[WHEEL_COUNT] = { 0.24f, 0.24f, 0.44f, 0.44f };
static float SPIN_HOLD_U_FLOOR_POS[WHEEL_COUNT] = { 0.24f, 0.24f, 0.32f, 0.32f };
static float SPIN_HOLD_U_FLOOR_NEG[WHEEL_COUNT] = { 0.22f, 0.22f, 0.30f, 0.30f };
...
static constexpr float SPIN_FLOOR_DISABLE_ABOVE_TARGET_RATIO = 2.00f;
