...
static float SPIN_U_FLOOR[WHEEL_COUNT] = { 0.26f, 0.26f, 0.36f, 0.36f };
static float SPIN_HOLD_U_FLOOR_POS[WHEEL_COUNT] = { 0.32f, 0.32f, 0.22f, 0.20f };
static float SPIN_HOLD_U_FLOOR_NEG[WHEEL_COUNT] = { 0.26f, 0.30f, 0.16f, 0.20f };
