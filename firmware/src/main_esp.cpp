...
static float SPIN_U_FLOOR[WHEEL_COUNT] = { 0.34f, 0.34f, 0.42f, 0.42f };
static float SPIN_HOLD_U_FLOOR_POS[WHEEL_COUNT] = { 0.36f, 0.36f, 0.28f, 0.28f };
static float SPIN_HOLD_U_FLOOR_NEG[WHEEL_COUNT] = { 0.34f, 0.34f, 0.26f, 0.26f };
